...
const groupProductsByPlatform = async (req, res) => {
    // Try to group by products by platform
    try {
        // Initialize variable
        const groupedProducts = await productService.groupProductsByPlatform();

        // Check if Products are grouped by with platform parameter
